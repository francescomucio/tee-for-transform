...
from t4t.importer.common.path_utils import (
...
class ModelConverter:
    ...
    def _convert_single_model(
        ...
        """
        from t4t.importer.dbt.converters import MetadataConverter, PythonModelGenerator
    ...
    def _write_metadata_file(
        ...
        """
        from t4t.importer.dbt.generators import write_metadata_file
