...
OPTION 1: Auto-executing class (cleanest, recommended)
    from t4t.parser.shared.model_builder_options import ModelBuilder
...
OPTION 2: Decorator pattern
    from t4t.parser.shared.model_builder_options import model
    from t4t.typing import ModelMetadata
...
OPTION 3: Import hook (most automatic)
    from t4t.parser.shared.model_builder_options import *
    from t4t.typing import ModelMetadata
...
# ============================================================================
# Usage:
#   from t4t.parser.shared.model_builder_options import build
#   from t4t.typing import ModelMetadata
#
#   metadata: ModelMetadata = {...}
...
# ============================================================================
# Usage:
#   from t4t.parser.shared.model_builder_options import setup_auto_build
#   setup_auto_build()
#   from t4t.typing import ModelMetadata
#
#   metadata: ModelMetadata = {...}
